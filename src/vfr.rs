...
//!
//! This module provides [`VfrAnalysis`] for detecting whether a video stream
...
pub(crate) fn analyze_vfr_impl(
    unbundler: &mut MediaUnbundler,
    video_stream_index: usize,
) -> Result<VfrAnalysis, UnbundleError> {
